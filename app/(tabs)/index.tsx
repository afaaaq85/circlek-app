      ...
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.form}>
          ...
          <View style={styles.inputContainer}>
            ...
            {errors.pipelineName && <Text style={styles.errorText}>{errors.pipelineName}</Text>}
          </View>
          ...
          <View style={styles.row}>
            ...
            <View style={[styles.inputContainer, styles.halfWidth]}>
              ...
              {errors.pressure && <Text style={styles.errorText}>{errors.pressure}</Text>}
            </View>
          </View>
          ...
          <View style={styles.row}>
            ...
            <View style={[styles.inputContainer, styles.halfWidth]}>
              ...
              {errors.flowRate && <Text style={styles.errorText}>{errors.flowRate}</Text>}
            </View>
          </View>
